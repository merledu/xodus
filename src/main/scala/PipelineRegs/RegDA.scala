...
class RegDA extends Module
{
    ...
    val u_j_imm  : SInt = dontTouch(WireInit(0.S(20.W)))
    ...
    Array(
        ...
        jalr_en_out,     auipc_en_out,    lui_en_out,
        ...
        jalr_en_in,      auipc_en_in,     lui_en_in
    ) foreach
    {
        x => x._1 := x._2
    }
