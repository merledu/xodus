...
class Top extends Module
{
    ...
    val BranchUnit : BranchUnit  = Module(new BranchUnit)
    ...
    *******************************************************/
    ...
    Seq(
        ...
        Fetch.io.forward_PC, Fetch.io.StallUnit_PC, Fetch.io.br_en,        Fetch.io.imm,            Fetch.io.RegFD_PC,
        ...
        // BranchUnit
        BranchUnit.io.rs1_data,            BranchUnit.io.rs2_data,      BranchUnit.io.func3,             BranchUnit.io.b_id,       BranchUnit.io.opcode,
        BranchUnit.io.alu,                 BranchUnit.io.RegAM_alu_out, BranchUnit.io.WriteBack_rd_data, BranchUnit.io.Memory_out, BranchUnit.io.forward_br_operand1,
        BranchUnit.io.forward_br_operand2,
        ...
        ControlUnit.io.u_lui_id,  ControlUnit.io.j_id,      ControlUnit.io.stallControl,
        ...
        ForwardUnit.io.load_en,        ForwardUnit.io.RegAM_load_en,  ForwardUnit.io.RegMW_load_en,
        ...
        RegMW.io.load_en_in, RegMW.io.PC4_in,

        // WriteBack
        WriteBack.io.PC,     WriteBack.io.alu,      WriteBack.io.mem_data, WriteBack.io.imm,     WriteBack.io.jalr_en,
        WriteBack.io.jal_en, WriteBack.io.auipc_en, WriteBack.io.lui_en,   WriteBack.io.load_en, WriteBack.io.PC4
    ) zip Seq(
        // Fetch
        WriteBack.io.nPC,        WriteBack.io.nPC_en, StallUnit.io.forward_inst, StallUnit.io.inst, StallUnit.io.stallPC_out,
        StallUnit.io.forward_PC, StallUnit.io.PC_out, BranchUnit.io.br_en,       Decoder.io.imm,    RegFD.io.PC_out,
        ...
        ALU.io.out,                         RegAM.io.alu_out,    WriteBack.io.rd_data, Memory.io.out,   ForwardUnit.io.forward_br_operand1,
        ForwardUnit.io.forward_br_operand2,
        ...
        Decoder.io.u_lui_id,  Decoder.io.j_id,      RegDA.io.stallControl_out,
        ...
        RegMW.io.wr_en_out,     RegDA.io.rd_addr_out,  Decoder.io.rs1_addr,  Decoder.io.rs2_addr, BranchUnit.io.b_en,
        ControlUnit.io.load_en, RegAM.io.load_en_out,  RegMW.io.load_en_out,
        ...
        ControlUnit.io.jalr_en, ControlUnit.io.j_en,  ControlUnit.io.auipc_en, ControlUnit.io.lui_en, RegDA.io.rs2_data_out,
        RegDA.io.PC4_out,
        ...
        RegAM.io.load_en_out, RegAM.io.PC4_out,

        // WriteBack
        RegMW.io.PC_out,     RegMW.io.alu_out,      RegMW.io.mem_data_out, RegMW.io.imm_out,     RegMW.io.jalr_en_out,
        RegMW.io.jal_en_out, RegMW.io.auipc_en_out, RegMW.io.lui_en_out,   RegMW.io.load_en_out, RegMW.io.PC4_out
    ) foreach
    {
        x => x._1 := x._2
    }
