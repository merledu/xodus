...
class Top extends Module
{
    ...
    *******************************************************/
    ...
    Seq(
        ...
        RegDA.io.jal_en_in,        RegDA.io.forward_rs1_rd_data, RegDA.io.forward_rs2_rd_data,
        ...
        JumpUnit.io.jal_en,              ForwardUnit.io.forward_rs1_rd_data, ForwardUnit.io.forward_rs2_rd_data,
